              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                {!hideConfirm &&
                  ...
                  >
                    ...
                    >
                    <LinearGradient style={{width:'100%',paddingVertical: 8,paddingHorizontal: 16,}} colors={['#7dde9d', '#17b7bd']} start={{ x: 0.0, y: 0.5 }} end={{ x: 1.0, y: 0.5 }} locations={[0.0, 1.0]} >
                      <Text style={[{ fontSize: 18, color: '#ffffff', textAlign:'center' }, confirmFont, styles.confirmText]}>{confirmText}</Text>
                    </LinearGradient>
